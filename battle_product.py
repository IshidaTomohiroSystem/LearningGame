...
class Battle_product(Game_product):
    def __init__(self, game_type, games, brain, mlagents, action_type, max_epochs, data):
        self.running_thread = []
        super(Battle_product, self).__init__(game_type, games, brain, mlagents, action_type, max_epochs, data)
    ...
    def create(self):
        ...
        self.running_thread = Worker_thread("test_thread", ModeData.battle, self.brain, 0, self.mlagents, self.action_type, self.max_epochs, self.data)
